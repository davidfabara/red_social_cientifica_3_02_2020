...
/* Las lineas anteriores implican la lista de variables globales */
...
if (annyang) {
    ...
    var commands = {
        ...
        'ayuda avanzada': () => {
            artyom.say("Para guardar en memoria pronuncia crear texto o para  deletrear di deletrear, seguido del caracter asi susecivamente, luego pronuncias, pegar pegar texto o deletrear, o borrar según sea el caso, seguido del nombre del input al que deseas asignar, ejemplo pegar texto en usuario");
        },
        'información': () => {
