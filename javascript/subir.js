...
function select_citar(subir_cont, tipoTextArea, tipoInput, tipoDiv){
    ...
    <input type = "button" value = "Cita basada en el autor(Cita textual y de mas de 40 palabras)" class = "boton" id="opcion3_${x}"
    ...
    <input type = "button" value="Cita basada en el texto(Cita textual y de mas de 40 palabras)" class = "boton" id="opcion4_${x}"
    ...
    <input type = "button" value="Anonimo" class = "boton" id="opcion8_${x}"
...
function select_referencia(subir_cont,tipoTextArea, tipoInput, tipoDiv){
    ...
    <input type = "button" value = "Libro en version electronica" class = "boton" id="opcion3_ref_${i}"
    ...
    <input type = "button" value = "Capitulo de un libro" class = "boton" id="opcion5_ref_${i}"
    onclick = "parrafo_referencias('${subir_cont}','${tipoTextArea}','${tipoInput}','${tipoDiv}','Capitulo de un libro')">
    <input type = "button" value = "Articulos cientificos" class = "boton" id="opcion6_ref_${i}"
    onclick = "parrafo_referencias('${subir_cont}','${tipoTextArea}','${tipoInput}','${tipoDiv}','Articulos cientificos')">
    <input type = "button" value = "Articulo con DOI" class = "boton" id="opcion7_ref_${i}"
    onclick = "parrafo_referencias('${subir_cont}','${tipoTextArea}','${tipoInput}','${tipoDiv}','Articulo con DOI')">
    <input type = "button" value = "Articulo online" class = "boton" id="opcion8_ref_${i}"
    onclick = "parrafo_referencias('${subir_cont}','${tipoTextArea}','${tipoInput}','${tipoDiv}','Articulo online')">
    <input type = "button" value = "Periodico impreso u online" class = "boton" id="opcion9_ref_${i}"
    onclick = "parrafo_referencias('${subir_cont}','${tipoTextArea}','${tipoInput}','${tipoDiv}','Periodico impreso u online')">
    <input type = "button" value = "Articulo de revista impreso u online" class = "boton" id="opcion10_ref_${i}"
    ...
    <input type = "button" value = "Referencia de pagina web" class = "boton" id="opcion14_ref_${i}"
    ...
    <input type = "button" value = "Enciclopedia en linea" class = "boton" id="opcion16_ref_${i}"
    onclick = "parrafo_referencias('${subir_cont}','${tipoTextArea}','${tipoInput}','${tipoDiv}','Enciclopedia en linea')">
    <input type = "button" value = "Pelicula o cinta cinematografica" class = "boton" id="opcion17_ref_${i}"
    onclick = "parrafo_referencias('${subir_cont}','${tipoTextArea}','${tipoInput}','${tipoDiv}','Pelicula o cinta cinematografica')">
    <input type = "button" value = "Serie de television" class = "boton" id="opcion18_ref_${i}"
    ...
    <input type = "button" value = "Grabacion de musica" class = "boton" id="opcion22_ref_${i}"
...
function parrafo_citar(subir_cont, tipoTextArea, tipoInput, tipoDiv, tipoCita){
    ...
    cita= "<label class=\"label\">Parrafo " +(y+2) + " de " +tipoTextArea+ " hacia referencia : "+tipoCita+" (Dejar en blanco si se ingresa manualmente)</label>"+"<textarea name=\"" +subir_cont+ "[" +tipoTextArea + "]"+"[" + (y) + "]"+"[" + (++n) + "]" + "[parrafo]"+ "\" + id=\"" + tipoTextArea + " " + (++j) + "\" class =\"contenidos\" rows=\"4\" cols=\"40\" placeholder=\"Parrafo " +(y+2) + " de " +tipoTextArea+ " hacia referencia : "+tipoCita+" (Dejar en blanco si se ingresa manualmente)\"></textarea><br>";
...
function parrafo_referencias(subir_cont, tipoTextArea, tipoInput, tipoDiv, tipoReferencia){
    ...
    referencia= "<label class=\"label\">Parrafo " +(i+2) + " de " +tipoTextArea+ " hacia referencia : "+tipoReferencia+" (Nota: aqui puede poner la cita manualmente o un parrafo referenciado a una cita)</label>"+"<textarea name=\"" +subir_cont+ "[" +tipoTextArea + "]"+"[" + (i) + "]"+"[" + (++n) + "]" + "[parrafo]"+ "\" id=\"" + tipoTextArea +" "+ (++j) + "\" class =\"contenidos\" rows=\"4\" cols=\"40\" placeholder=\"parrafo " +(i+2) + " de " +tipoTextArea+ " hacia referencia : "+tipoReferencia+"\"></textarea><br>";
...
function config_cita(subir_cont, tipoTextArea, tipoInput, tipoDiv, tipoCita, n, y, j ){
    ...
    if(tipoCita==="Cita de una cita"){
        cita+= "<label>Apellido-s de autor de opinión o afirmación de "+tipoCita+ " para parrafo "+(y+2)+"(Separar cada uno con coma, si son 3 a 5 autores se separan con \"comas\" si hay mas de 6 autores solo se pone el primero y \"et al.\" al final)<input type=\"text\"" + "name=\"" +subir_cont+ "[" +tipoTextArea + "]"+"[" + (y) + "]"+ "[" + (++n) + "]" + "[apellido]"+"\" id=\"" + tipoTextArea + " " + (++j) + "\" placeholder=\"Apellido-s de autor\" class = \"contenidos\"></label><br><hr>" +
